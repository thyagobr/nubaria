...
const check_collisions = () => {
  if ((spell.active) && ((0,_tapete_js__WEBPACK_IMPORTED_MODULE_5__.is_colliding)(spell.bounds(), go.selected_clickable))) {
    go.selected_clickable.current_hp -= (0,_tapete_js__WEBPACK_IMPORTED_MODULE_5__.random)(1, 5);
