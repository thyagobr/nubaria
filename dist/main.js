...
const spell = new _projectile_js__WEBPACK_IMPORTED_MODULE_19__["default"](go);
const cast_spell = () => {
...
const check_collisions = () => {
  if ((spell.active) && ((0,_tapete_js__WEBPACK_IMPORTED_MODULE_5__.is_colliding)(spell.bounds(), creep))) {
