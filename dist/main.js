...
function Character(go, id) {
  ...
  const near_bonfire = () => this.go.fires.some(fire => _tapete_js__WEBPACK_IMPORTED_MODULE_0__.Vector2.distance(this, fire) < 20);
...
function update_boonfires_fuel() {
  for (let index = 0; index < go.fires.length; index++) {
    ...
    if (fire.fuel <= 0) { (0,_tapete_js__WEBPACK_IMPORTED_MODULE_5__.remove_object_if_present)(fire, go.fires)
    } else {
      fire.fuel -= 1;
